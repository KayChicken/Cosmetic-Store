...
const PickUp = () => {
    return (
        <section className="pickup__section">
            <div className="pickup__container">
                <div className="pickup__title">Эффективность составов IRC</div>
                <div className="pickup__desc">подтверждена мировыми исследованиями ведущих научных центров</div>
                <div className="pickup__logos">
                    <img src="./img/pickup/sesderma.png" alt="" />
                    <img src="./img/pickup/iff.png" alt="" />
                </div>
                <div className="pickup__btn__wrapper">
