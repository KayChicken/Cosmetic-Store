...
const NewsCard: React.FC<NewsCardProps> = ({ img, title, desc }) => {
    return (
...
const News = () => {
    ...
    useEffect(() => {
        const images = document.querySelectorAll<HTMLDivElement>('.news__carousel .news__card')
        setWidth(images[0].clientWidth + 10)
        const handleResize = () => {
            setWidth(images[0].clientWidth + 10)
        }
    ...
    return (
        <section className="section__news">
            <h1>Блог/новости/Акции</h1>
            <div className="news__slider">
                <div className="news__carousel" ref={carousel}>

                    <NewsCard title='Маска для лица в домашних условиях' img='news1' desc='Часто ли вы делаете дома маски для лица? Если обычно вам лень или некогда, исправляйтесь – маски содержат высокую концентрацию активных ингредиентов и способны решить множество проблем кожи, от прыщей до ранних морщинок.' />
                    <NewsCard title='Нужен ли специальный уход мужской коже?' img='news2' desc='Замечаете, что мужчина втихаря пользуется вашей умывалкой или кремом? Поощряйте его желание выглядеть свежим и ухоженным, а мы поможем вам в этом – расскажем обо всех особенностях кожи представителей сильного пола и подберем средства IRC 24|7' />
                    <NewsCard title='Уход за комбинированной кожей' img='news3' desc='Комбинированная, она же смешанная, кожа ведет двойную игру. Где искать волшебное средство, которое поможет сразу и блестящему носу, и щелущашимся щекам?' />
                    <NewsCard title='Какие эффективные бьюти-процедуры можно делать ' img='news4' desc='Вынужденный отказ от посещения салонов красоты – совсем не повод забросить уход за собой! Напротив, время самоизоляции и удаленной работы – отличная возможность уделить волосам, ногтям и, конечно, коже больше внимания, а многие бьюти-процедуры, ' />
                    <NewsCard title='Маска для лица в домашних условиях' img='news1' desc='Часто ли вы делаете дома маски для лица? Если обычно вам лень или некогда, исправляйтесь – маски содержат высокую концентрацию активных ингредиентов и способны решить множество проблем кожи, от прыщей до ранних морщинок.' />

                </div>
                <div className="carousel__arrows">
                    <svg width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => { scrollCarousel('left') }}>
                    ...
                    <svg width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => { scrollCarousel('right') }}>
